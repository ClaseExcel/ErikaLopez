...
function(t, e) {
    ...
    B.d = (t, e) => {
        for (var i in e)
            B.o(e, i) && !B.o(t, i) && Object.defineProperty(t, i, {
                enumerable: !0,
                get: e[i]
            })
    }
    ...
    a.supportsPassiveEvents = function() {
        ...
        if (!a.isMS) {
            ...
            a.win.addEventListener && a.win.removeEventListener && (a.win.addEventListener("testPassive", a.noop, e),
 ...
 - ${i}: ${e}`,
    ...
    let ta = (i = Math.random().toString(36).substring(2, 9) + "-",
    s = 0,
    function() {
    ...
    H.jQuery && (H.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
            return t[0] ? (new z[G(t[0]) ? t.shift() : "Chart"](this[0],t[0],t[1]),
            this) : R[_(this[0], "data-highcharts-chart")]
    }
    );
    let tn = {
        ...
        getNestedProperty: function(t, e) {
            ...
            for (; i.length && Z(e); ) {
                ...
                let s = e[t.replace(/[\\'"]/g, "")];
                if (!Z(s) || "function" == typeof s || "number" == typeof s.nodeType || s === H)
                    return;
                e = s
            }
            return e
      ...
      , {defined: td, error: tc, extend: tp, isNumber: tg, isObject: tu, isString: tf, merge: tm, objectEach: tx, pad: ty, splat: tb, timeUnits: tv, ucfirst: tk} = tn
        ...
        dateTimeFormat(t, e, i=this.options.locale || th) {
            ...
            if (!o) {
                ...
                try {
                    ...
                    /Invalid time zone/i.test(e.message) ? (tc(34),
                    t.timeZone = "UTC",
                    o = new Intl.DateTimeFormat(i,t)) : tc(e.message, !1)
                }
            }
      ...
      , tA = class extends tM {
        getTimeTicks(t, e, i, s) {
            ...
            if (s ?? (s = 1),
            tS(e)) {
                if (f = h >= tC.second ? 0 : n * Math.floor(f / n),
                h >= tC.second && (u = h >= tC.minute ? 0 : n * Math.floor(u / n)),
                h >= tC.minute && (g = h >= tC.hour ? 0 : n * Math.floor(g / n)),
                h >= tC.hour && (p = h >= tC.day ? 0 : n * Math.floor(p / n)),
                h >= tC.day && (c = h >= tC.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                ...
                o.variableTimezone && tS(i) && (m = i - e > 4 * tC.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i));
                let t = e
                  , x = 1;
                for (; t < i; )
                    r.push(t),
                    h === tC.year ? t = o.makeTime(l + x * n, 0) : h === tC.month ? t = o.makeTime(l, d + x * n) : m && (h === tC.day || h === tC.week) ? t = o.makeTime(l, d, c + x * n * (h === tC.day ? 1 : 7)) : m && h === tC.hour && n > 1 ? t = o.makeTime(l, d, c, p + x * n) : t += h * n,
                    x++;
                r.push(t),
                h <= tC.hour && r.length < 1e4 && r.forEach(t => {
      ...
      , tD = {
        ...
        setOptions: function(t) {
            ...
            t.lang && "locale"in t.lang && tI.update({
    ...
    class tG {
        ...
        brighten(t) {
            ...
            if (this.stops)
                ...
                if (tN(e[0]))
                    ...
                    tG.useColorMix && tF(this.input) && (this.output = tX(this.input, t > 0 ? "white" : "black", Math.abs(t)));
            return this
        }
        setOpacity(t) {
        ...
        tweenTo(t, e) {
            let i = this.rgba
              , s = t.rgba;
            if (!tN(i[0]) || !tN(s[0]))
                return tG.useColorMix && tF(this.input) && tF(t.input) && e < .99 ? tX(this.input, t.input, e) : t.input || "none";
            let o = 1 !== s[3] || 1 !== i[3]
              , r = (t, s) => t + (i[s] - t) * (1 - e)
    ...
    tG.useColorMix = tB.CSS?.supports("color", "color-mix(in srgb,red,blue 9%)"),
    tG.None = new tG("");
    let {parse: tY} = tG
      , {win: tj} = z
    ...
    class tV {
        ...
        run(t, e, i) {
            ...
            r.elem = this.elem,
            r.prop = this.prop,
            r() && 1 === tV.timers.push(r) && a(n)) : (delete o.curAnim[this.prop],
        ...
        initPath(t, e, i) {
            ...
            return g.length && tU(l) && (d = r.length + l * n,
            p ? (u(g, r),
            f(r)) : (u(r, g),
            f(g))),
            [g, r]
    ...
    function t3(t, e) {
        ...
        for (; i--; )
            tV.timers[i].elem !== t || e && e !== tV.timers[i].prop || (tV.timers[i].stopped = !0)
    }
    let t5 = {
        animate: function(t, e, i) {
            ...
            t0(e, function(n, h) {
                ...
                a = new tV(t,i,h),
                r = void 0,
                "d" === h && tq(e.d) ? (a.paths = a.initPath(t, t.pathArray, e.d),
                a.toD = e.d,
                s = 0,
                r = 1) : t.attr ? s = t.attr(h) : (s = parseFloat(t_(t, h)) || 0,
                "opacity" !== h && (o = "px")),
                r || (r = n),
        ...
        getDeferredAnimation: function(t, e, i) {
            ...
            return o.forEach(t => {
                ...
                r = tJ(e) && tZ(e.defer) ? s.defer : Math.max(r, i.duration + i.defer),
      ...
      , {SVG_NS: t6, win: t9} = z
      , {attr: t4, createElement: t8, css: t7, error: et, isFunction: ee, isString: ei, objectEach: es, splat: eo} = tn
      , {trustedTypes: er} = t9
    ...
    class eh {
        static filterUserAttributes(t) {
            return es(t, (e, i) => {
                ...
                -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = ei(e) && eh.allowedReferences.some(t => 0 === e.indexOf(t))),
                s || (et(33, !1, void 0, {
        ...
        static setElementHTML(t, e) {
            t.innerHTML = eh.emptyHTML,
            e && new eh(e).addToDOM(t)
        }
        constructor(t) {
        ...
        addToDOM(t) {
            return function t(e, i) {
                ...
                return eo(e).forEach(function(e) {
                    let o, r = e.tagName, a = e.textContent ? z.doc.createTextNode(e.textContent) : void 0, n = eh.bypassHTMLFiltering;
                    if (r)
                        if ("#text" === r)
                            o = a;
    ...
    let {defaultOptions: el, defaultTime: ed} = tD
      ...
      , ek = {};
    function ew(t="", e, i) {
        let s = RegExp("\\{([\\p{L}\\d:\\.,;\\-\\/<>\\[\\]%_@+\"'’= #\\(\\)]+)\\}", "gu"), o = RegExp("\\(([\\p{L}\\d:\\.,;\\-\\/<>\\[\\]%_@+\"'= ]+)\\)", "gu"), r = [], a = /f$/, n = /\.(\d)/, h = i?.options?.lang || el.lang, l = i?.time || ed, d = i?.numberFormatter || eM.bind(i), c = (t="") => {
            let i;
        ...
        return r.forEach(s => {
            ...
            if (m) {
                ...
                for (p = ev[m].length; p--; )
                    t.unshift(c(o[p + 1]));
                r = ev[m].apply(e, t),
                s.isBlock && "boolean" == typeof r && (r = ew(r ? g : u, e, i))
            } else {
    ...
    function eM(t, e, i, s) {
        e *= 1;
        let o, r, [a,n] = (t = +t || 0).toString().split("e").map(Number), h = this?.options?.lang || el.lang, l = (t.toString().split(".")[1] || "").split("e")[0].length, d = e, c = {};
        i ?? (i = h.decimalPoint),
        s ?? (s = h.thousandsSep),
        -1 === e ? e = Math.min(l, 20) : ef(e) ? e && n < 0 && ((r = e + n) >= 0 ? (a = +a.toExponential(r).split("e")[0],
        e = r) : (a = Math.floor(a),
        t = e < 20 ? +(a * Math.pow(10, n)).toFixed(e) : 0,
        n = 0)) : e = 2,
        n && (e ?? (e = 2),
        t = a),
        ef(e) && e >= 0 && (c.minimumFractionDigits = e,
        c.maximumFractionDigits = e),
        "" === s && (c.useGrouping = !1);
        let p = s || i
          , g = p ? "en" : this?.locale || h.locale || ec
          , u = JSON.stringify(c) + g;
        return o = (ek[u] ?? (ek[u] = new Intl.NumberFormat(g,c))).format(t),
    ...
    (y || (y = {})).distribute = function t(e, i, s) {
        ...
        for (c = h; c--; )
            x += e[c].size;
        if (x > r) {
            for (eL(e, (t, e) => (e.rank || 0) - (t.rank || 0)),
    ...
    let eO = y
      ...
      , {deg2rad: eB, doc: eN, svg: ez, SVG_NS: eR, win: eW, isFirefox: eH} = z
      , {addEvent: eX, attr: eF, createElement: eG, crisp: eY, css: ej, defined: eU, erase: e$, extend: eV, fireEvent: eZ, getAlignFactor: e_, isArray: eq, isFunction: eK, isNumber: eJ, isObject: eQ, isString: e0, merge: e1, objectEach: e2, pick: e3, pInt: e5, pushUnique: e6, replaceNested: e9, syncTimeout: e4, uniqueKey: e8} = tn;
    class e7 {
        _defaultGetter(t) {
        ...
        attr(t, e, i, s) {
            let {element: o} = this, r = e7.symbolCustomAttribs, a, n, h = this, l;
            return "string" == typeof t && void 0 !== e && (a = t,
            (t = {})[a] = e),
            "string" == typeof t ? h = (this[t + "Getter"] || this._defaultGetter).call(this, t, o) : (e2(t, function(e, i) {
                l = !1,
                s || eD(this, i),
        ...
        complexColor(t, e, i) {
            ...
            eZ(this.renderer, "complexColor", {
                ...
                r) {
                    ...
                    "radialGradient" === r && p && !eU(a.gradientUnits) && (n = a,
        ...
        css(t) {
            ...
            r) {
                e && (t = eV(e, i)),
                null === t.width || "auto" === t.width ? delete this.textWidth : "text" === s.nodeName.toLowerCase() && t.width && (o = this.textWidth = e5(t.width)),
                eV(this.styles, t),
        ...
        dSetter(t, e, i) {
            eq(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)),
            this.pathArray = t,
        ...
        getBBox(t, e) {
            let i, s, o, {element: r, renderer: a, styles: n, textStr: h} = this, {cache: l, cacheKeys: d} = a, c = r.namespaceURI === this.SVG_NS, p = e3(e, this.rotation, 0), g = a.styledMode ? r && e7.prototype.getStyle.call(r, "font-size") : n.fontSize, u = this.getBBoxCacheKey([a.rootFontSize, this.textWidth, this.alignValue, n.fontWeight, n.lineClamp, n.textOverflow, g, p]);
            if (u && !t && (i = l[u]),
            !i || i.polygon) {
                if (c || a.forExport) {
                    try {
        ...
        constructor(t, e) {
            ...
            this.opacity = 1,
            this.SVG_NS = eR,
            this.element = "span" === e || "body" === e ? eG(e) : eN.createElementNS(this.SVG_NS, e),
            this.renderer = t,
            this.styles = {},
            eZ(this, "afterInit")
        }
        ...
        shadow(t) {
            let {renderer: e} = this
              , i = e1(this.parentGroup?.rotation === 90 ? {
                offsetX: -1,
                offsetY: -1
            } : {}, eQ(t) ? t : {})
        ...
        titleSetter(t) {
            ...
            i.textContent = e9(e3(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
        }
        toFront() {
            let t = this.element;
        ...
        zIndexSetter(t, e) {
            ...
            if (eU(t) ? (r.setAttribute("data-z-index", t),
            t *= 1,
            this[e] === t && (p = !1)) : eU(this[e]) && r.removeAttribute("data-z-index"),
            this[e] = t,
            p) {
                ...
                g = (n = o.childNodes).length - 1; g >= 0 && !d; g--)
                    ...
                    d = !0) : (e5(l) <= t || c && (!eU(t) || t >= 0)) && (o.insertBefore(r, n[g + 1]),
                    d = !0));
    ...
    e7.symbolCustomAttribs = ["anchorX", "anchorY", "clockwise", "end", "height", "innerR", "r", "start", "width", "x", "y"],
    e7.prototype.strokeSetter = e7.prototype.fillSetter,
    e7.prototype.yGetter = e7.prototype.xGetter,
    e7.prototype.matrixSetter = e7.prototype.rotationOriginXSetter = e7.prototype.rotationOriginYSetter = e7.prototype.rotationSetter = e7.prototype.scaleXSetter = e7.prototype.scaleYSetter = e7.prototype.translateXSetter = e7.prototype.translateYSetter = e7.prototype.verticalAlignSetter = function(t, e) {
        this[e] = t,
        this.doTransform = !0
    }
    ;
    let it = e7
      , {defined: ie, extend: ii, getAlignFactor: is, isNumber: io, merge: ir, pick: ia, removeEvent: ih} = tn;
    class il extends it {
        ...
        alignSetter(t) {
            ...
            this.bBox && io(this.xSetting) && this.attr({
                x: this.xSetting
            }),
        ...
        updateBoxSize() {
            let t, e = this.text, i = {}, s = this.padding, o = this.bBox = (!io(this.widthSetting) || !io(this.heightSetting) || this.textAlign) && ie(e.textStr) ? e.getBBox(void 0, 0) : il.emptyBBox;
        ...
        widthSetter(t) {
            this.widthSetting = io(t) ? t : void 0,
            this.doUpdate = !0
        }
        getPaddedWidth() {
            let t = this.padding
    ...
    function ig(t, e, i, s, o) {
        ...
        if (o) {
            ...
            id(p) && ((b = ["A", p, p, 0, y, id(o.clockwise) ? 1 - o.clockwise : 0, t + p * u, e + p * f]).params = {
                start: n,
                end: a,
                cx: t,
                cy: e
    ...
    function iu(t, e, i, s, o) {
        return o?.r ? im(t, e, i, s, o) : [["M", t, e], ["L", t + i, e], ["L", t + i, e + s], ["L", t, e + s], ["Z"]]
    }
    ...
    let ix = {
      ...
      , {attr: ik, extend: iw, fireEvent: iM, isString: iS, objectEach: iT, pick: iC} = tn
      ...
      , iP = class {
        ...
        buildSVG() {
            ...
            if (n !== t.textCache) {
                ...
                if (o || this.ellipsis || this.width || t.textPath || -1 !== s.indexOf(" ") && (!this.noWrap || /<br.*?>/g.test(s))) {
                    ...
                    e.appendChild(iy.createTextNode(this.unescapeEntities(s)));
                iS(this.textOutline) && t.applyTextOutline && t.applyTextOutline(this.textOutline)
            }
        }
        modifyDOM() {
            let t, e = this.svgElement, i = ik(e.element, "x");
            ...
            let o = (t, o) => {
              ...
              , r = t => {
                [].slice.call(t.childNodes).forEach(i => {
                    i.nodeType === iv.Node.TEXT_NODE ? o(i, t) : (-1 !== i.className.baseVal.indexOf("highcharts-br") && (e.actualWidth = 0),
                    r(i))
                }
                )
            }
        ...
        modifyTree(t) {
            ...
            ;
            t.forEach(e),
            iM(this.svgElement, "afterModifyTree", {
                nodes: t
            })
        }
      ...
      , {charts: iO, deg2rad: iE, doc: iI, isFirefox: iD, isMS: iB, isWebKit: iN, noop: iz, SVG_NS: iR, symbolSizes: iW, win: iH} = z
      , {addEvent: iX, attr: iF, createElement: iG, crisp: iY, css: ij, defined: iU, destroyObjectProperties: i$, extend: iV, isArray: iZ, isNumber: i_, isObject: iq, isString: iK, merge: iJ, pick: iQ, pInt: i0, replaceNested: i1, uniqueKey: i2} = tn;
    class i3 {
        constructor(t, e, i, s, o, r, a) {
            ...
            this.createElement("desc").add().element.appendChild(iI.createTextNode("Created with Highcharts 12.5.0")),
            ...
            this.setSize(e, i, !1),
            iD && t.getBoundingClientRect && ((n = function() {
                ij(t, {
                    left: 0,
                    top: 0
                }),
        ...
        getReferenceURL() {
            if ((iD || iN) && iI.getElementsByTagName("base").length) {
                if (!iU(e)) {
                    ...
                    e = s?.id === "hitme",
                    iI.body.removeChild(i)
                }
                if (e)
                    return i1(iH.location.href.split("#")[0], [/<[^>]*>/g, ""], [/([\('\)])/g, "\\$1"], [/ /g, "%20"])
            }
            return ""
        }
        getStyle(t) {
        ...
        button(t, e, i, s, o={}, r, a, n, h, l) {
            ...
            return c || ["hover", "select", "disabled"].forEach( (t, e) => {
                m.push(iJ(m[0], eh.filterUserAttributes(p[e + 5] || u[t] || {}))),
                x.push(m[e + 1].style),
                delete m[e + 1].style
            }
            ),
        ...
        crispLine(t, e) {
            let[i,s] = t;
            return iU(i[1]) && i[1] === s[1] && (i[1] = s[1] = iY(i[1], e)),
        ...
        symbol(t, e, i, s, o, r) {
            ...
            if (u)
                ...
                s.isImg = !0,
                s.symbolUrl = t,
                iU(s.imgwidth) && iU(s.imgheight) ? l(s) : (s.attr({
                    width: 0,
                    height: 0
                }),
                iG("img", {
        ...
        pathToSegments(t) {
            ...
            for (let o = 0; o < t.length; o++)
                iK(i[0]) && i_(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")),
    ...
    let {composed: i5, isFirefox: i6} = z
      , {attr: i9, css: i4, createElement: i8, defined: i7, extend: st, getAlignFactor: se, isNumber: si, pInt: ss, pushUnique: so} = tn;
    function sr(t, e, i) {
    ...
    class sn extends it {
        ...
        constructor(t, e) {
            super(t, e),
            sn.useForeignObject ? this.foreignObject = t.createElement("foreignObject").attr({
                zIndex: 2
            }) : this.css({
                position: "absolute",
                ...t.styledMode ? {} : {
        ...
        updateTransform() {
            ...
            let {element: t, foreignObject: e, oldTextWidth: i, renderer: s, rotation: o, rotationOriginX: r, rotationOriginY: a, scaleX: n, scaleY: h, styles: {display: l="inline-block", whiteSpace: d}, textAlign: c="left", textWidth: p, translateX: g=0, translateY: u=0, x: f=0, y: m=0} = this
              , x = () => this.textPxLength ? this.textPxLength : (i4(t, {
                width: "",
                whiteSpace: d || "nowrap"
            }),
            t.offsetWidth);
            ...
            "SPAN" === t.tagName) {
                let g, u = [o, c, t.innerHTML, p, this.textAlign].join(","), y = -(this.parentGroup?.padding * 1) || 0;
                if (p !== i) {
                    let e = x()
                      , r = p || 0
                ...
                i7(o) && !e && (o !== (this.oldRotation || 0) || c !== this.oldAlign) && i4(t, {
    ...
    sh.ySetter = sh.rotationSetter = sh.rotationOriginXSetter = sh.rotationOriginYSetter = sh.xSetter,
    (h = b || (b = {})).xAxis = {
        alignTicks: !0,
    ...
    (v || (v = {})).registerEventOptions = function(t, e) {
        ...
        sp(e.events, function(e, i) {
            t.eventOptions[i] !== e && (t.eventOptions[i] && (sg(t, i, t.eventOptions[i]),
            delete t.eventOptions[i]),
            sc(e) && (t.eventOptions[i] = e,
            sd(t, i, e, {
                order: 0
            })))
        })
    ...
    let su = v
      , {deg2rad: sf} = z
      , {clamp: sm, correctFloat: sx, defined: sy, destroyObjectProperties: sb, extend: sv, fireEvent: sk, getAlignFactor: sw, isNumber: sM, merge: sS, objectEach: sT, pick: sC} = tn
      , sA = class {
        ...
        addLabel() {
            let t = this, e = t.axis, i = e.options, s = e.chart, o = e.categories, r = e.logarithmic, a = e.names, n = t.pos, h = sC(t.options?.labels, i.labels), l = e.tickPositions, d = n === l[0], c = n === l[l.length - 1], p = (!h.step || 1 === h.step) && 1 === e.tickInterval, g = l.info, u = t.label, f, m, x, y = this.parameters.category || (o ? sC(o[n], a[n], n) : n);
            r && sM(y) && (y = sx(r.lin2log(y))),
            e.dateTime && (g ? f = (m = s.time.resolveDTLFormat(i.dateTimeLabelFormats[!i.grid?.enabled && g.higherRanks[n] || g.unitName])).main : sM(y) && (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
            t.isFirst = d,
            t.isLast = c;
            let b = {
                axis: e,
            ...
            eS.format(h.format, t, s)) : e.defaultLabelFormatter.call(t)
              , k = v.call(b, b)
              , w = m?.list;
            ...
            sy(u) || t.movedLabel ? u && u.textStr !== k && !p && (!u.textWidth || h.style.width || u.styles.width || u.css({
                width: null
            }),
            u.attr({
                text: k
        ...
        getPosition(t, e, i, s) {
            ...
            return n.y = sm(n.y, -1e9, 1e9),
            sk(this, "afterGetPosition", {
                pos: n
            }),
            n
        }
        getLabelPosition(t, e, i, s, o, r, a, n) {
            ...
            return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? u.y + m : Math.cos(i.rotation * sf) * (u.y - i.getBBox(!1, 0).height / 2),
            sy(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
            t = t + sC(o.x, [0, 1, 0, -1][d.side] * m) + f + u.x - (r && s ? r * c * (p ? -1 : 1) : 0),
        ...
        handleOverflow(t) {
            let e = this.axis, i = e.options.labels, s = t.x, o = e.chart.chartWidth, r = e.chart.spacing, a = sC(e.labelLeft, Math.min(e.pos, r[3])), n = sC(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, o - r[1])), h = this.label, l = this.rotation, d = sw(e.labelAlign || h.attr("align")), c = h.getBBox().width, p = e.getSlotWidth(this), g = p, u = 1, f;
            l || "justify" !== i.overflow ? l < 0 && s - d * c < a ? f = Math.round(s / Math.cos(l * sf) - a) : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * sf))) : (s - d * c < a ? g = t.x + g * (1 - d) - a : s + (1 - d) * c > n && (g = n - t.x + g * d,
            u = -1),
            (g = Math.min(p, g)) < p && "center" === e.labelAlign && (t.x += u * (p - g - d * (p - Math.min(c, g)))),
            (c > g || e.autoRotation && h?.styles?.width) && (f = g)),
            f && h && (this.shortenLabel ? this.shortenLabel() : h.css(sv({}, {
        ...
        moveLabel(t, e) {
            ...
            r = !0,
            delete i.label) : sT(o.ticks, function(e) {
        ...
        renderGridLine(t, e) {
            let i = this.axis, s = i.options, o = {}, r = this.pos, a = this.type, n = sC(this.tickmarkOffset, i.tickmarkOffset), h = i.chart.renderer, l = this.gridLine, d, c = s.gridLineWidth, p = s.gridLineColor, g = s.gridLineDashStyle;
        ...
        renderLabel(t, e, i, s) {
            let o = this.axis
              ...
              , p = t.y
              , g = !0;
            n && sM(c) && (n.xy = t = this.getLabelPosition(c, p, n, r, h, d, s, l),
    ...
    class s5 {
        ...
        init(t, e, i=this.coll) {
            ...
            this.side = sJ(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3),
            this.setOptions(e);
            let r = this.options
              , a = r.labels;
            ...
            this.categories = s$(r.categories) && r.categories || (this.hasNames ? [] : void 0),
            ...
            t.inverted && !this.isZAxis && s && !sW(this.reversed) && (this.reversed = !0),
        ...
        setOptions(t) {
            ...
            sY(this, "afterSetOptions", {
                userOptions: t
            })
        }
        defaultLabelFormatter() {
            let t = this.axis, {numberFormatter: e} = this.chart, i = sV(this.value) ? this.value : NaN, s = t.chart.time, o = t.categories, r = this.dateTimeLabelFormat, a = sE.lang, n = a.numericSymbols, h = a.numericSymbolMagnitude || 1e3, l = t.logarithmic ? Math.abs(i) : t.tickInterval, d = n?.length, c, p;
            if (o)
                p = `${this.value}`;
            else if (r)
                ...
                e.series.forEach(i => {
                    if (i.reserveSpace()) {
                        ...
                        e.isXAxis)
                            ...
                            n = t.max,
                            sV(a) || a instanceof Date || (o = o.filter(sV),
                            a = (t = i.getXExtremes(o)).min,
                            n = t.max),
                            o.length && (e.dataMin = Math.min(sJ(e.dataMin, a), a),
                            e.dataMax = Math.max(sJ(e.dataMax, n), n)));
                        else {
                            let t = i.applyExtremes();
                            sV(t.dataMin) && (a = t.dataMin,
                            e.dataMin = Math.min(sJ(e.dataMin, a), a)),
                            sV(t.dataMax) && (n = t.dataMax,
                            e.dataMax = Math.max(sJ(e.dataMax, n), n)),
                            sW(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
            ...
            function y(t, e, i) {
                return "pass" !== p && (t < e || t > i) && (p ? t = sz(t, e, i) : x = !0),
                t
            }
            let b = {
                value: a,
            ...
            return sY(this, "getPlotLinePath", b, function(t) {
                g = f = (c = sz(c = sJ(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d,
                u = m = h - c - d,
                sV(c) ? e.horiz ? (u = o,
        ...
        getLinearTickPositions(t, e, i) {
            let s, o, r, a = sR(Math.floor(e / t) * t), n = sR(Math.ceil(i / t) * t), h = [];
            if (sR(a + t) === a && (r = 20),
            this.single)
                return [e];
        ...
        adjustForMinRange() {
            ...
            sV(s) && sV(o) && sV(r) && s - o < r && (n = this.dataMax - this.dataMin >= r,
            a = (r - s + o) / 2,
        ...
        nameToX(t) {
            let e = s$(this.options.categories), i = e ? this.categories : this.names, s = t.options.x, o;
            return t.series.requireSorting = !1,
            sW(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : sJ(i.keys[t.name], -1) : t.series.autoIncrement()),
        ...
        setTickInterval(t) {
            ...
            this.type !== y.type && sF(11, !0, i)) : (l && sW(c) && sV(s) && sV(o) && (o >= c ? (T = c,
            k = 0) : s <= c && (C = c,
            v = 0)),
            this.min = sJ(A, T, o),
            this.max = sJ(P, C, s)),
            sV(this.max) && sV(this.min) && (n && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, sJ(o, this.min)) && sF(10, !0, i),
            this.min = sR(n.log2lin(this.min), 16),
            this.max = sR(n.log2lin(this.max), 16)),
            this.range && sV(o) && (this.userMin = this.min = A = Math.max(o, this.minFromRange() || 0),
            this.userMax = P = this.max,
            this.range = void 0)),
            sY(this, "foundExtremes"),
            this.adjustForMinRange(),
            sV(this.min) && sV(this.max)) {
                if (!sV(this.userMin) && sV(x) && x < this.min && (this.min = A = x),
                !sV(this.userMax) && sV(m) && m > this.max && (this.max = P = m),
                e || this.axisPointRange || this.stacking?.usePercentage || y || (w = this.max - this.min) && (!sW(A) && k && (this.min -= w * k),
                !sW(P) && v && (this.max += w * v)),
                ...
                !i.polar && this.min > this.max && (sW(h.min) ? this.max = this.min : sW(h.max) && (this.min = this.max)),
                w = this.max - this.min
            }
            if (this.min !== this.max && sV(this.min) && sV(this.max) ? y && !S && b === y.options.tickPixelInterval ? this.tickInterval = S = y.tickInterval : this.tickInterval = sJ(S, this.tickAmount ? w / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : w * b / Math.max(this.len, b)) : this.tickInterval = 1,
            a && !t) {
        ...
        setTickPositions() {
            ...
            this.single = this.min === this.max && sW(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals),
            e)
                n = e.slice();
            ...
            !this.isLinked && sV(this.min) && sV(this.max) && (this.single && n.length < 2 && !this.categories && !this.series.some(t => t.is("heatmap") && "between" === t.options.pointPlacement) && (this.min -= .5,
            this.max += .5),
        ...
        getThresholdAlignment(t) {
            if ((!sV(this.dataMin) || this !== t && this.series.some(t => t.isDirty || t.isDirtyData || t.xAxis?.isDirty)) && this.getSeriesExtremes(),
            sV(this.threshold)) {
        ...
        getTickAmount() {
            let t = this.options
              ...
              , i = t.tickAmount;
            sW(t.tickInterval) || i || !(this.len < e) || this.isRadial || this.logarithmic || !t.startOnTick || !t.endOnTick || (i = 2),
        ...
        adjustTickAmount() {
            let t = this, {finalTickAmt: e, max: i, min: s, options: o, tickPositions: r, tickAmount: a, thresholdAlignment: n} = t, h = r?.length, l = sJ(t.threshold, t.softThreshold ? 0 : null), d, c, p = t.tickInterval, g, u = () => r.push(sR(r[r.length - 1] + p)), f = () => r.unshift(sR(r[0] - p));
            if (sV(n) && (g = 0 === n ? 0 : 1 === n ? a - 1 : Math.round(sz(n * (a - 1), 1, a - 2)),
            o.reversed && (g = a - 1 - g)),
            t.hasData() && sV(s) && sV(i)) {
                let n = () => {
                    t.transA *= (h - 1) / (a - 1),
        ...
        tickSize(t) {
            let e = this.options, i = sJ(e["tick" === t ? "tickWidth" : "minorTickWidth"], "tick" === t && this.isXAxis && !this.categories ? 1 : 0), s = e["tick" === t ? "tickLength" : "minorTickLength"], o;
            i && s && ("inside" === e[t + "Position"] && (s = -s),
            o = [s, i]);
            let r = {
                tickSize: o
            };
            return sY(this, "afterTickSize", r),
            r.tickSize
        }
        labelMetrics() {
        ...
        unsquish() {
            let t = this.options.labels, e = t.padding || 0, i = this.horiz, s = this.tickInterval, o = this.len / ((+!!this.categories + this.max - this.min) / s), r = t.rotation, a = sR(.8 * this.labelMetrics().h), n = Math.max(this.max - this.min, 0), h = function(t) {
                let i = (t + 2 * e) / (o || 1);
                return (i = i > 1 ? Math.ceil(i) : 1) * s > n && t !== 1 / 0 && o !== 1 / 0 && n && (i = Math.ceil(n / s)),
                sR(i * s)
            }, l = s, d, c = Number.MAX_VALUE, p;
            if (i) {
                if (!t.staggerLines && (sV(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)),
                p) {
                    let t, e;
                    for (let i of p)
                        (i === r || i && i >= -90 && i <= 90) && (e = (t = h(Math.abs(a / Math.sin(sD * i)))) + Math.abs(i / 360)) < c && (c = e,
                        d = i,
                        l = t)
                }
            } else
        ...
        renderUnsquish() {
            ...
            i.forEach(function(t) {
                let e = s[t]
                  ...
                  , a = {};
                i && (i.attr(l),
                e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "SPAN" === i.element.tagName) ? i.css(sG(a, {
                    width: `${p}px`,
                    lineClamp: g
        ...
        getOffset() {
            let t = this, {chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n} = t, h = e.inverted && !t.isZAxis ? [1, 0, 3, 2][o] : o, l = t.hasData(), d = s.title, c = s.labels, p = sV(s.crossing), g = e.axisOffset, u = e.clipOffset, f = [-1, 1, 1, -1][o], m, x = 0, y, b = 0, v = 0, k, w;
            ...
            sJ(c.reserveSpace, !p && null, "center" === t.labelAlign || null, t.reserveSpaceDefault) && a.forEach(function(t) {
                v = Math.max(r[t].getLabelSize(), v)
            }),
            t.staggerLines && (v *= t.staggerLines),
            t.labelOffset = v * (t.opposite ? -1 : 1)) : sK(r, function(t, e) {
                t.destroy(),
                delete r[e]
            }),
            ...
            k = Math.abs(v) + b,
            v && (k -= w,
            k += f * (i ? sJ(c.y, t.tickRotCorr.y + f * c.distance) : sJ(c.x, f * c.distance))),
        ...
        render() {
            let t, e, i = this, s = i.chart, o = i.logarithmic, r = s.renderer, a = i.options, n = i.isLinked, h = i.tickPositions, l = i.axisTitle, d = i.ticks, c = i.minorTicks, p = i.alternateBands, g = a.stackLabels, u = a.alternateGridColor, f = a.crossing, m = i.tickmarkOffset, x = i.axisLine, y = i.showAxis, b = sP(r.globalAnimation);
            ...
            if (i.hasData() || n) {
                ...
                u && h.forEach(function(r, a) {
                    ...
                    a % 2 == 0 && r < i.max && e <= i.max + (s.polar ? -m : m) && (p[r] || (p[r] = new z.PlotLineOrBand(i,{})),
                    t = r + m,
                    p[r].options = {
        ...
        drawCrosshair(t, e) {
            ...
            t || (t = this.cross?.e),
            i && !1 !== (sW(e) || !s)) {
                if (s ? sW(e) && (a = sJ("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY)) : a = t && (this.horiz ? t.chartX - this.pos : this.len - t.chartY + this.pos),
                sW(a) && (l = {
    ...
    !function(t) {
        ...
        class s {
            ...
            normalizeTimeTickInterval(t, e) {
                let i = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]], s = i[i.length - 1], o = s8[s[0]], r = s[1], a;
                for (a = 0; a < i.length && (o = s8[(s = i[a])[0]],
                r = s[1],
                !i[a + 1] || !(t <= (o * r[r.length - 1] + s8[i[a + 1][0]]) / 2)); a++)
                    ;
        ...
        class s {
            ...
            getLogTickPositions(t, e, i, s) {
                ...
                t >= .5)
                    ...
                    t = oe(t = oi("auto" === d ? null : d, this.minorAutoInterval, (l - h) * c / (p || 1))),
    ...
    !function(t) {
        ...
        function r(t, e, i) {
            ...
            }), o = [], r = this.horiz, a = !oa(this.min) || !oa(this.max) || t < this.min && e < this.min || t > this.max && e > this.max, n = this.getPlotLinePath({
                value: t,
                force: !0,
                acrossPanes: i.acrossPanes
            }), h, l = 1, d;
    ...
    let on = M
      , {addEvent: oh, arrayMax: ol, arrayMin: od, defined: oc, destroyObjectProperties: op, erase: og, fireEvent: ou, merge: of, objectEach: om, pick: ox} = tn;
    class oy {
        static compose(t, e) {
        ...
        render() {
            ou(this, "render");
            let {axis: t, options: e} = this, {horiz: i, logarithmic: s} = t, {color: o, events: r, zIndex: a=0} = e, {renderer: n, time: h} = t.chart, l = {}, d = h.parse(e.to), c = h.parse(e.from), p = h.parse(e.value), g = e.borderWidth, u = e.label, {label: f, svgElem: m} = this, x = [], y, b = oc(c) && oc(d), v = oc(p), k = !m, w = {
            ...
            u && (oc(u.text) || oc(u.formatter)) && x?.length && t.width > 0 && t.height > 0 && !x.isFlat ? (u = of({
        ...
        renderLabel(t, e, i, s) {
            ...
            (!n.alignValue || "left" === n.alignValue || oc(a)) && n.css({
        ...
        destroy() {
            og(this.axis.plotLinesAndBands, this),
            delete this.axis,
            op(this)
        }
    }
    let {animObject: ob} = t5
      ...
      , {distribute: oT} = eO
      , {addEvent: oC, clamp: oA, css: oP, clearTimeout: oL, discardElement: oO, extend: oE, fireEvent: oI, getAlignFactor: oD, isArray: oB, isNumber: oN, isObject: oz, isString: oR, merge: oW, pick: oH, pushUnique: oX, splat: oF, syncTimeout: oG} = tn;
    class oY {
        constructor(t, e, i) {
            this.allowShared = !0,
            this.crosshairs = [],
        ...
        getLabel({anchorX: t, anchorY: e}={
            ...
            return a && !a.parentElement && z.doc.body.appendChild(a),
            this.label
        }
        getPlayingField() {
        ...
        getPosition(t, e, i) {
            ...
            let M = !this.followPointer && oH(i.ttBelow, !d && !n === w)
              ...
              , A = () => {
                !1 !== S.apply(0, b) ? !1 !== T.apply(0, v) || k || (C(!0),
                A()) : k ? g.x = g.y = 0 : (C(!0),
                A())
            }
            ;
        ...
        init(t, e) {
            ...
            this.outside = oH(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY))
        }
        ...
        refresh(t, e) {
            ...
            if (!s.enabled || !n.series)
                return;
            oL(this.hideTimer),
            this.allowShared = !(!oB(t) && t.series && t.series.noSharedTooltip),
            ...
            n.points = void 0;
            let m = n.series;
            if (this.distance = oH(m.tooltipOptions.distance, 16),
            !1 === f)
                this.hide();
            else {
        ...
        headerFooterFormatter(t, e) {
            ...
            return oI(this, "headerFormatter", a, function(e) {
                if (r && !n && oN(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                r && n) {
                    if (oz(n)) {
                        let t = n;
                        ow[0] = e => i.chart.time.dateFormat(t, e),
                        n = "%0"
                    }
        ...
        update(t) {
            this.destroy(),
            this.init(this.chart, oW(!0, this.options, t))
        }
        updatePosition(t) {
            let {chart: e, container: i, distance: s, options: o, pointer: r, renderer: a} = this, {height: n=0, width: h=0} = this.getLabel(), {fixed: l, positioner: d} = o, {left: c, top: p, scaleX: g, scaleY: u} = r.getChartPosition(), f = (d || l && this.getFixedPosition || this.getPosition).call(this, h, n, t), m = z.doc, x = (t.plotX || 0) + e.plotLeft, y = (t.plotY || 0) + e.plotTop, b;
            if (a && i) {
                if (d || l) {
    ...
    let oj = oY
      ...
      , {defaultOptions: o$} = tD
      , {format: oV} = eS
      , {addEvent: oZ, crisp: o_, erase: oq, extend: oK, fireEvent: oJ, getNestedProperty: oQ, isArray: o0, isFunction: o1, isNumber: o2, isObject: o3, merge: o5, pick: o6, syncTimeout: o9, removeEvent: o4, uniqueKey: o8} = tn;
    class o7 {
        constructor(t, e, i) {
        ...
        applyOptions(t, e) {
            ...
            return oK(this, t = o7.prototype.optionsToObject.call(this, t)),
            ...
            void 0 === this.x && i ? this.x = e ?? i.autoIncrement() : o2(t.x) && i.options.relativeXValue ? this.x = i.autoIncrement(t.x) : "string" == typeof this.x && (e ?? (e = i.chart.time.parse(this.x)),
            o2(e) && (this.x = e)),
        ...
        destroy() {
            if (!this.destroyed) {
                let t = this
                  ...
                  , a = () => {
                    for (let e in (t.graphic || t.graphics || t.dataLabel || t.dataLabels) && (o4(t),
                    t.destroyElements()),
                    t)
                        delete t[e]
                }
        ...
        optionsToObject(t) {
            ...
            if (o2(t) || null === t)
                ...
                n++); h < o; )
                    i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? o7.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]),
                    n++,
                    h++;
            else
                "object" == typeof t && (r = t,
        ...
        update(t, e, i, s) {
            ...
            function d() {
                ...
                o3(t, !0) && (n?.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = n.destroy()),
                ...
                l.data[o] = o3(l.data[o], !0) || o3(t, !0) ? r.options : o6(t, l.data[o]),
        ...
        manageEvent(t) {
            let e = o5(this.series.options.point, this.options)
              , i = e.events?.[t];
            o1(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1) ? (this.importedUserEvent?.(),
            this.importedUserEvent = oZ(this, t, i),
            this.hcEvents && (this.hcEvents[t].userEvent = !0)) : this.importedUserEvent && !i && this.hcEvents?.[t] && this.hcEvents?.[t].userEvent && (o4(this, t),
            delete this.hcEvents[t],
            Object.keys(this.hcEvents) || delete this.importedUserEvent)
        }
        setState(t, e) {
            let i = this.series, s = this.state, o = i.options.states[t || "normal"] || {}, r = o$.plotOptions[i.type].marker && i.options.marker, a = r && !1 === r.enabled, n = r?.states?.[t || "normal"] || {}, h = !1 === n.enabled, l = this.marker || {}, d = i.chart, c = r && i.markerAttribs, p = i.halo, g, u, f, m = i.stateMarkerGraphic, x;
            ...
            this.graphic && !this.hasMockGraphic) {
                ...
                g && this.graphic.animate(g, o6(d.options.chart.animation, n.animation, r.animation)),
                m && m.hide()
            } else
                ...
                g && (m ? m[e ? "animate" : "attr"]({
                    x: g.x,
                    y: g.y
                }) : x && (i.stateMarkerGraphic = m = d.renderer.symbol(x, g.x, g.y, g.width, g.height, o5(r, n)).add(i.markerGroup),
                m.currentSymbol = x)),
    ...
    let rt = o7
      ...
      , {addEvent: rr, attr: ra, css: rn, extend: rh, find: rl, fireEvent: rd, isNumber: rc, isObject: rp, objectEach: rg, offset: ru, pick: rf, pushUnique: rm, splat: rx} = tn;
    class ry {
        ...
        destroy() {
            ...
            this.eventsToUnbind = [],
            !z.chartCount && (ry.unbindDocumentMouseUp.forEach(t => t.unbind()),
            ry.unbindDocumentMouseUp.length = 0,
            ry.unbindDocumentTouchEnd && (ry.unbindDocumentTouchEnd = ry.unbindDocumentTouchEnd())),
            rg(t, function(e, i) {
                t[i] = void 0
            })
        }
        ...
        drag(t) {
            let {chart: e} = this, {mouseDownX: i=0, mouseDownY: s=0} = e, {panning: o, panKey: r, selectionMarkerFill: a} = e.options.chart, n = e.plotLeft, h = e.plotTop, l = e.plotWidth, d = e.plotHeight, c = rp(o) ? o.enabled : o, p = r && t[`${r}Key`], g = t.chartX, u = t.chartY, f, m = this.selectionMarker;
        ...
        getSelectionBox(t) {
            ...
            return rd(this, "getSelectionBox", e),
            e.result
        }
        drop(t) {
        ...
        findNearestKDPoint(t, e, i) {
            ...
            return t.forEach(function(t) {
                ...
                rp(l, !0) && l.series && (!rp(s, !0) || (r = (o = s).distX - l.distX,
                a = o.dist - l.dist,
        ...
        getChartCoordinatesFromPoint(t, e) {
            ...
            if (i && s) {
                let r = t.clientX ?? t.plotX ?? 0
                  , a = t.plotY || 0;
                return t.isNode && o && rc(o.x) && rc(o.y) && (r = o.x,
                a = o.y),
                e ? {
        ...
        getHoverData(t, e, i, s, o, r) {
            ...
            c && (o && !h.noSharedTooltip ? (l = i.filter(function(t) {
                ...
                rp(i) && (t.boosted && t.boost && (i = t.boost.getPoint(i)),
                a.push(i))
            }) : a.push(c)),
            rd(this, "afterGetHoverData", d = {
                hoverPoint: c
            }),
            {
        ...
        onContainerClick(t) {
            ...
            e.hoverPoint && i.firePointEvent("click", s)) : (rh(s, this.getCoordinates(s)),
        ...
        pinch(t) {
            ...
            e.res = !0,
            i.mouseDownX = t.chartX) : l ? this.runPointActions(e.normalize(t)) : o && (rd(i, "touchpan", {
                originalEvent: t,
                touches: r
            }, () => {
                let e = t => {
        ...
        runPointActions(t, e, i) {
            ...
            this.unDocMouseMove || (this.unDocMouseMove = rr(s.container.ownerDocument, "mousemove", t => ri[ry.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)),
            this.eventsToUnbind.push(this.unDocMouseMove)),
            s.axes.forEach(function(e) {
                let i, o = e.crosshair?.snap ?? !0;
                o && ((i = s.hoverPoint) && i.series[e.coll] === e || (i = rl(c, t => t.series?.[e.coll] === e))),
        ...
        setDOMEvents() {
            ...
            this.eventsToUnbind.push(rr(t, "mouseenter", this.onContainerMouseEnter.bind(this)), rr(t, "mouseleave", this.onContainerMouseLeave.bind(this))),
            ry.unbindDocumentMouseUp.some(t => t.doc === e) || ry.unbindDocumentMouseUp.push({
                doc: e,
                unbind: rr(e, "mouseup", this.onDocumentMouseUp.bind(this))
            });
            let s = i(this.chart.renderTo);
            for (; s && "BODY" !== s.tagName; )
                this.eventsToUnbind.push(rr(s, "scroll", () => {
                    delete this.chartPosition
                }
                )),
                s = i(s);
        ...
        touch(t, e) {
            ...
            rf(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t)
        }
        touchSelect(t) {
    ...
    let {setLength: rv, splice: rk} = S
      ...
      , rT = class {
        ...
        setColumns(t, e, i) {
            ...
            i?.silent || (rw(this, "afterSetColumns"),
            this.versionTag = rS())
        }
        setRow(t, e=this.rowCount, i, s) {
            ...
            rM(o, (a, n) => {
                ...
                a && (i ? a = rk(a, e, 0, !0, [t[n] ?? null]).array : a[e] = t[n] ?? null,
                o[n] = a)
            }
            ),
            r > this.rowCount && this.applyRowCount(r),
            s?.silent || (rw(this, "afterSetRows"),
            this.versionTag = rS())
        }
        getModified() {
    ...
    function rO(t, e, i) {
        ...
        if (m && !1 !== m.enabled && n) {
            ...
            t = 0),
            s.symbol = f = c.symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, rC({
                context: "legend"
    ...
    rz.seriesType = function(t, e, i, s, o) {
        ...
        o) {
            ...
            rD(e.prototype, o),
            rz.seriesTypes[t].prototype.pointClass = e
        }
    ...
    class an {
            ...
            r6(this, "bindAxes", null, function() {
                (e.axisTypes || []).forEach(function(o) {
                    (s[o] || []).forEach(function(s) {
                        t = s.options,
                        (ao(i[o], 0) === s.index || void 0 !== i[o] && i[o] === t.id) && (r8(e, s.series),
                        e[o] = s,
                        s.isDirty = !0)
                    }),
        ...
        autoIncrement(t) {
            ...
            if (this.pointInterval = e = ao(this.pointInterval, i.pointInterval, 1),
            o && at(t) && (e *= t),
            s) {
                let t = r.toParts(a);
            ...
            return o && at(t) ? a + e : (this.xIncrement = a + e,
            a)
        }
        ...
        setOptions(t) {
            let e, i = this.chart, s = i.options.plotOptions, o = i.userOptions || {}, r = ai(t), a = i.styledMode, n = {
                plotOptions: s,
                userOptions: r
            };
            ...
            this.tooltipOptions = ai(rF.tooltip, rF.plotOptions.series?.tooltip, c?.tooltip, i.userOptions.tooltip, l.series?.tooltip, p.tooltip, r.tooltip),
            this.stickyTracking = ao(r.stickyTracking, p.stickyTracking, d.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g.stickyTracking),
            ...
            u.push(e)),
            u.length && rJ(u[u.length - 1].value) && u.push(a ? {} : {
                color: this.color,
        ...
        getCyclic(t, e, i) {
            ...
            !e && (rJ(o = ao("color" === t ? this.options.colorIndex : void 0, this[a])) ? s = o : (r.series.length || (r[n] = 0),
            s = r[n] % h,
            r[n] += 1),
            i && (e = i[s])),
            void 0 !== s && (this[a] = s),
        ...
        updateData(t, e) {
            let {options: i, requireSorting: s} = this, o = i.dataSorting, r = this.points, a = [], n = t.length === r.length, h = this.xIncrement, l, d, c, p, g = !0;
            if (this.xIncrement = null,
            t.forEach( (t, e) => {
                let h, d = rJ(t) && this.pointClass.prototype.optionsToObject.call({
                    series: this
                }, t) || {}, {id: c, x: g} = d;
                c || at(g) ? (-1 === (h = this.findPointIndex(d, p)) || void 0 === h ? a.push(t) : r[h] && t !== i.data?.[h] ? (r[h].update(t, !1, void 0, !1),
                r[h].touched = !0,
            ...
            return null !== h && null === this.xIncrement && u.length && (this.xIncrement = rV(u),
            this.autoIncrement()),
            !0
        }
        dataColumnKeys() {
        ...
        setData(t, e=!0, i, s) {
            ...
            !x) {
                ...
                for (ae(this.getColumn("y")[0]) && r2(14, !0, n),
                this.data = [],
        ...
        getProcessedData(t) {
            ...
            s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < u || m[0] > f ? x = new rT : e.getColumn(e.pointValKey || "y").length && (m[0] < u || m[l - 1] > f) && (x = (d = this.cropData(i, u, f)).modified,
            p = d.start,
            c = !0))),
            m = x.getColumn("x") || [],
            {
        ...
        generatePoints() {
            let t = this.options, e = this.processedData || t.data, i = this.dataTable.getModified(), s = this.getColumn("x", !0), o = this.pointClass, r = i.rowCount, a = this.cropStart || 0, n = this.hasGroupedData, h = t.keys, l = [], d = t.dataGrouping?.groupAll ? a : 0, c = this.pointArrayMap || ["y"], p = this.dataColumnKeys(), g, u, f, m, x = this.data, y;
            if (!x && !n) {
                let t = [];
                t.length = e?.length || 0,
                x = this.data = t
            ...
            m = 0; m < r; m++)
                ...
                delete f.dataLabels,
                f.key = f.name ?? f.category)) : (f = x[u],
                y = e ? e[u] : i.getRow(m, c),
                f || void 0 === y ? f && (f.category = this.xAxis?.categories?.[f.x] ?? f.x,
                f.key = f.name ?? f.category) : x[u] = f = new o(this,y,s[m])),
                f && (f.index = n ? d + m : u,
                l[m] = f);
        ...
        translate() {
            ...
            for (p = 0; p < a; p++) {
                ...
                a.plotX = at(g = i.translate(y, !1, !1, !1, !0, n)) ? rq(x(g)) : void 0,
                ...
                a.percentage = rJ(a.y) && b.total ? a.y / b.total * 100 : void 0,
                a.stackY = k,
                ...
                at(k) && void 0 !== a.plotX ? t = at(t = o.translate(k, !1, !0, !1, !0)) ? x(t) : void 0 : !at(k) && c && (t = c),
                a.plotY = t,
        ...
        drawPoints(t=this.points) {
            let e, i, s, o, r, a, n, h = this.chart, l = h.styledMode, {colorAxis: d, options: c} = this, p = c.marker, g = c.nullInteraction, u = this[this.specialGroup || "markerGroup"], f = this.xAxis, m = ao(p.enabled, !f || !!f.isRadial || null, this.closestPointRangePx >= p.enabledThreshold * p.radius);
        ...
        markerAttribs(t, e) {
            let i = this.options, s = i.marker, o = t.marker || {}, r = o.symbol || s.symbol, a = {}, n, h, l = ao(o.radius, s?.radius);
            e && (n = s.states[e],
            ...
            t.hasImage && (l = 0);
            let d = t.pos();
            return at(l) && d && (i.crisp && (d[0] = rK(d[0], t.hasImage ? 0 : "rect" === r ? s?.lineWidth || 0 : 1)),
            a.x = d[0] - l,
            a.y = d[1] - l),
        ...
        pointAttribs(t, e) {
            let i = this.options, s = i.marker, o = t?.options, r = o?.marker || {}, a = o?.color, n = t?.color, h = t?.zone?.color, l, d, c = this.color, p, g, u = ao(r.lineWidth, s.lineWidth), f = t?.isNull && i.nullInteraction ? 0 : 1;
            return c = a || h || n || c,
            p = r.fillColor || s.fillColor || c,
            g = r.lineColor || s.lineColor || c,
            e = e || "normal",
            l = s.states[e] || {},
            u = ao((d = r.states && r.states[e] || {}).lineWidth, l.lineWidth, u + ao(d.lineWidthPlus, l.lineWidthPlus, 0)),
        ...
        destroy(t) {
            let e, i, s = this, o = s.chart, r = /AppleWebKit\/533/.test(rj.navigator.userAgent), a = s.data || [];
            for (r6(s, "destroy", {
        ...
        applyZones() {
            ...
            if (s.length && (i || t) && d && at(d.min)) {
                ...
                if (s.forEach(t => {
                    t.lineClip = [],
                    t.translated = r_(d.toPixels(ao(t.value, e), !0) || 0, 0, p)
                }
                ),
        ...
        plotGroup(t, e, i, s, o) {
            ...
            return rJ(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n.opacity = this.opacity),
            r || (this[t] = r = this.chart.renderer.g().add(o)),
            r.addClass("highcharts-" + e + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (rJ(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0),
            ...
            this.kdTree)
                return function t(e, i, s, o) {
                    ...
                    let M = (e[v] || 0) - (b[v] || 0) + (d && b.marker?.radius || 0)
                      , S = M < 0 ? "left" : "right"
                      , T = M < 0 ? "right" : "left";
                    return i[S] && ([k,w] = c(b, t(e, i[S], s + 1, o), h)),
                    i[T] && p(Math.sqrt(M * M), k[h], w) && (k = c(k, t(e, i[T], s + 1, o), h)[0]),
                    k
                }(t, this.kdTree, l, l)
        }
        ...
        addPoint(t, e, i, s, o) {
            ...
            i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, g].filter(rJ).forEach(t => {
                t.shift()
            }
            ),
            d.deleteRows(0))),
            !1 !== o && r6(this, "addPoint", {
                point: f
            }),
            this.isDirty = !0,
            this.isDirtyData = !0,
        ...
        update(t, e) {
            ...
            let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions, n = rU[r].prototype, h = i.finishedAnimating && {
                animation: !1
            }, l = {}, d, c, p = an.keepProps.slice(), g = t.type || o.type || s.options.chart.type, u = !(this.hasDerivedData || g && g !== this.type || void 0 !== t.keys || void 0 !== t.pointStart || void 0 !== t.pointInterval || void 0 !== t.relativeXValue || t.joinBy || t.mapData || ["dataGrouping", "pointStart", "pointInterval", "pointIntervalUnit", "keys"].some(t => i.hasOptionChanged(t)));
            g = g || r,
            u ? (p.push.apply(p, an.keepPropsForPoints),
            !1 !== t.visible && p.push("area", "graph"),
            i.parallelArrays.forEach(function(t) {
                p.push(t + "Data")
            }),
            t.data && (t.dataSorting && r3(i.options.dataSorting, t.dataSorting),
    ...
    an.keepProps = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"],
    an.keepPropsForPoints = ["data", "isDirtyData", "isDirtyCanvas", "points", "dataTable", "processedData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"],
    r3(an.prototype, {
    ...
    let ah = an
      ...
      , {distribute: au} = eO
      , {format: af} = eS
      , {addEvent: am, createElement: ax, css: ay, defined: ab, discardElement: av, find: ak, fireEvent: aw, isNumber: aM, merge: aS, pick: aT, pushUnique: aC, relativeLength: aA, stableSort: aP, syncTimeout: aL} = tn;
    class aO {
        constructor(t, e) {
            this.allItems = [],
            this.initialItemY = 0,
        ...
        colorizeItem(t, e) {
            ...
            if ((t instanceof ah || t instanceof rt) && (t.color = t.options?.legendSymbolColor || i),
        ...
        renderItem(t) {
            ...
            o.squareSymbol && (this.symbolWidth = aT(o.symbolWidth, Math.max(this.symbolHeight, 16)),
        ...
        proximatePositions() {
            ...
            for (let o of (this.allItems.forEach(function(t) {
                ...
                t.points && (o = ak(a ? t.points : t.points.slice(0).reverse(), function(t) {
                    return aM(t.plotY)
                })),
        ...
        render() {
            ...
            this.renderTitle(),
            aP(r, (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)),
            ...
            n = (s.maxWidth ? Math.min(this.widthOption || this.offsetWidth, d, aA(s.maxWidth, t.chartWidth) || 1 / 0) : this.widthOption || this.offsetWidth) + o,
        ...
        handleOverflow(t) {
            let e = this, i = this.chart, s = i.renderer, o = this.options, r = o.y, a = "top" === o.verticalAlign, n = this.padding, h = o.maxHeight, l = o.navigation, d = aT(l.animation, !0), c = l.arrowSize || 12, p = this.pages, g = this.allItems, u = function(t) {
        ...
        setItemEvents(t, e, i) {
            ...
            for (let i of d)
                i && i.on("mouseover", function() {
                    ...
                    s.chart.styledMode || e.css(aS(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(""),
                    r.removeClass(h),
                    t.setState()
                }).on("click", function(e) {
    ...
    class nn {
        ...
        init(t, e) {
            a1(this, "init", {
                ...
                (this.renderTo = a4(o) ? aH.getElementById(o) : o) || aJ(13, !0, this),
                this.margin = [],
                this.spacing = [],
        ...
        isInsidePlot(t, e, i={}) {
            ...
            return a1(this, "afterIsInsidePlot", u),
            u.isInsidePlot
        }
        redraw(t) {
        ...
        createAxes() {
            ...
            for (let e of (a1(this, "createAxes"),
            ["xAxis", "yAxis"]))
                for (let i of t[e] = no(t[e] || {}))
                    new s5(this,i,e);
        ...
        getChartSize() {
            ...
            this.chartHeight = Math.max(0, ni(i, this.chartWidth) || (o ? 400 : s.height)),
            this.containerBox = s
        }
        temporaryDisplay(t) {
            ...
            if (t)
                for (; e?.style; )
                    e.hcOrigStyle && (aV(e, e.hcOrigStyle),
                    delete e.hcOrigStyle),
                    e.hcOrigDetached && (aH.body.removeChild(e),
                    e.hcOrigDetached = !1),
                    e = e.parentNode;
            else
                for (; e?.style && (aH.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0,
                aH.body.appendChild(e)),
                ("none" === a3(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
        ...
        getContainer() {
            let t, e = this.options, i = e.chart, s = "data-highcharts-chart", o = na(), r = this.renderTo, a = ne(aU(r, s));
        ...
        getMargins(t) {
            ...
            this.resetMargins(),
            s[0] && !aZ(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])),
            s[2] && !aZ(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
        ...
        reflow(t) {
            ...
            !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (tn.clearTimeout(e.reflowTimeout),
            ...
            t)) {
                ...
                if (this.hasCartesianSeries && e.horiz && e.visible && i.enabled && e.series.length && "colorAxis" !== e.coll && !this.polar) {
                    ...
                    let s = new sA(e,0,"",!0)
                      , o = s.createLabel("x", i);
                    if (s.destroy(),
                    o && nt(i.reserveSpace, !a6(t.crossing)) && (r = o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
                    r) {
                        o?.destroy();
                        break
                    }
        ...
        createAxis(t, e) {
            ...
            return nt(e.redraw, !0) && this.redraw(e.animation),
            i
        }
        showLoading(t) {
            let e = this
        ...
        update(t, e, i, s) {
            ...
            a7(t, function(e, i) {
                n[i] && "function" == typeof n[i].update ? n[i].update(e, !1) : "function" == typeof n[h[i]] ? n[h[i]](e) : "colors" !== i && -1 === n.collectionsWithUpdate.indexOf(i) && a8(!0, n.options[i], t[i]),
            ...
            this.collectionsWithUpdate.forEach(function(e) {
                t[e] && (no(t[e]).forEach(function(t, s) {
                    let o, r = aZ(t.id);
                    r && (o = n.get(t.id)),
                    !o && n[e] && (o = n[e][nt(t.index, s)]) && (r && aZ(o.options.id) || o.options.isInternal) && (o = void 0),
            ...
            a || a6(p) && p !== n.chartWidth || a6(g) && g !== n.chartHeight ? n.setSize(p, g, s) : nt(e, !0) && n.redraw(s),
            a1(n, "afterUpdate", {
                options: t,
                redraw: e,
                animation: s
            ...
            for (let t of e) {
                ...
                1 === w && !o && "yAxis" === t.coll && !E) {
                    for (let e of t.series) {
                        ...
                        a6(t.dataMin) && a6(t.dataMax) && (E.dataMin = Math.min(t.dataMin, E.dataMin),
                        E.dataMax = Math.max(t.dataMax, E.dataMax))
                    }
                    t.allExtremes = E
                }
                let {dataMin: I, dataMax: D, min: B, max: N} = aQ(t.getExtremes(), E || {})
                  , z = d.parse(m.min)
                  , R = d.parse(m.max)
                  , W = I ?? z
                  , H = D ?? R
                ...
                (!t.isOrdinal || 1 !== w || o) && (L < U && (L = U,
                w >= 1 && (O = L + X)),
                O > $ && (O = $,
                w >= 1 && (L = O - X)),
                (o || t.series.length && (L !== B || O !== N) && L >= U && O <= $) && (r ? r[t.coll].push({
                    axis: t,
                    min: L,
                    max: O
                }) : (t.isPanning = "zoom" !== n,
    ...
    let {stop: nh} = t5
      , {composed: nl} = z
      , {addEvent: nd, createElement: nc, css: np, defined: ng, erase: nu, merge: nf, pushUnique: nm} = tn;
    function nx() {
        let t = this.scrollablePlotArea;
        (this.scrollablePixelsX || this.scrollablePixelsY) && !t && (this.scrollablePlotArea = t = new nb(this)),
        t?.applyFixed()
    }
    function ny() {
    ...
    class nb {
        static compose(t, e, i) {
            nm(nl, this.compose) && (nd(t, "afterInit", ny),
        ...
        moveFixedElements() {
            let t, {container: e, inverted: i, scrollablePixelsX: s, scrollablePixelsY: o} = this.chart, r = this.fixedRenderer, a = nb.fixedSelectors;
    ...
    let {format: nv} = eS
      , {series: nk} = rW
      , {destroyObjectProperties: nw, fireEvent: nM, getAlignFactor: nS, isNumber: nT, pick: nC} = tn
      , nA = class {
        constructor(t, e, i, s, o) {
        ...
        setOffset(t, e, i, s, o, r) {
            let {alignOptions: a, axis: n, label: h, options: l, textAlign: d} = this
              ...
              , {verticalAlign: g} = a;
            if (h && p) {
                let t = h.getBBox(void 0, 0), e = h.padding, i = "justify" === nC(l.overflow, "justify"), s;
                a.x = l.x || 0,
                a.y = l.y || 0;
                ...
                i && nk.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p),
                h.attr({
                    x: h.alignAttr.x,
                    y: h.alignAttr.y,
                    rotation: l.rotation,
                ...
                nC(!i && l.crop, !0) && (s = nT(h.x) && nT(h.y) && c.isInsidePlot(h.x - e + (h.width || 0), h.y) && c.isInsidePlot(h.x + e, h.y)),
                h[s ? "show" : "hide"]()
            }
      ...
      , {series: {prototype: nL}} = rW
      , {addEvent: nO, correctFloat: nE, defined: nI, destroyObjectProperties: nD, fireEvent: nB, isNumber: nN, objectEach: nz, pick: nR} = tn;
    function nW() {
        let t = this.inverted;
        this.axes.forEach(t => {
    ...
    function nU(t, e) {
        ...
        h = 0; h < g; h++) {
            ...
            w[a][e].total = null) : w[a][e] = new nA(t,t.options.stackLabels,!!s,e,x)),
            o = w[a][e],
            null !== g ? (o.points[n] = o.points[this.index] = [nR(o.cumulative, m)],
            ...
            let S = o.total || 0;
            "percent" === l ? (r = s ? y : b,
            S = v && w[r]?.[e] ? (r = w[r][e]).total = Math.max(r.total || 0, S) + Math.abs(u) : nE(S + Math.abs(u))) : "group" === l ? nN(g) && S++ : S = nE(S + u),
            "group" === l ? o.cumulative = (S || 1) - 1 : o.cumulative = nE(nR(o.cumulative, m) + u),
            o.total = S,
    ...
    class n$ {
        ...
        resetStacks() {
            nz(this.stacks, t => {
                nz(t, (e, i) => {
                    nN(e.touched) && e.touched < this.stacksTouched ? (e.destroy(),
    ...
    class nK extends ah {
        ...
        getGraphPath(t, e, i) {
            ...
            (t = this.getValidPoints(t, !1, o.nullInteraction || !(o.connectNulls && !e && !i))).forEach(function(l, d) {
                ...
                f && !nZ(e) && d > 0 ? n = !o.connectNulls : f && !e ? n = !0 : (0 === d || n ? c = [["M", l.plotX, l.plotY]] : s.getPointSpline ? c = [s.getPointSpline(t, l, d)] : h ? (c = 1 === h ? [["L", u.plotX, g]] : 2 === h ? [["L", (u.plotX + p) / 2, u.plotY], ["L", (u.plotX + p) / 2, g]] : [["L", p, u.plotY]]).push(["L", p, g]) : c = [["L", p, g]],
                a.push(l.x),
                h && (a.push(l.x),
                2 === h && a.push(l.x)),
                r.push.apply(r, c),
    ...
    class n3 extends nJ {
        ...
        getGraphPath(t) {
            let e, i, s, o = nJ.prototype.getGraphPath, r = this.options, a = r.stacking, n = this.yAxis, h = [], l = [], d = this.index, c = n.stacking.stacks[this.stackKey], p = r.threshold, g = Math.round(n.getThreshold(r.threshold)), u = n2(r.connectNulls, "percent" === a), f = function(i, s, o) {
    ...
    let n8 = n4
      , {area: n7, area: {prototype: ht}} = rW.seriesTypes
    ...
    let {animObject: ho} = t5
      , {parse: hr} = tG
      , {noop: ha} = z
      , {clamp: hn, crisp: hh, defined: hl, extend: hd, fireEvent: hc, isArray: hp, isNumber: hg, merge: hu, pick: hf, objectEach: hm} = tn;
    class hx extends ah {
        animate(t) {
        ...
        crispCol(t, e, i, s) {
            ...
            return s = hh(e + s, o, r) - (e = hh(e, o, r)),
        ...
        translate() {
            ...
            t.points.forEach(function(s) {
                let o = hf(s.yBottom, u), m = 999 + Math.abs(o), x = s.plotX || 0, y = hn(s.plotY, -m, a.len + m), b, v = Math.min(y, o), k = Math.max(y, o) - v, w = d, M = x + c, S = f;
                h && Math.abs(k) < h && (k = h,
                b = !a.reversed && !s.negative || a.reversed && s.negative,
                hg(n) && hg(g) && s.y === n && g <= n && (a.min || 0) < n && (p !== g || (a.max || 0) <= n) && (b = !b,
                s.negative = !s.negative),
                v = Math.abs(v - u) > h ? o - h : u - (b ? h : 0)),
                hl(s.options.pointWidth) && (M -= Math.round(((w = S = Math.ceil(s.options.pointWidth)) - d) / 2)),
                i.centerInCategory && (M = t.adjustForMissingColumns(M, w, s, l)),
                s.barX = M,
                s.pointWidth = w,
                s.tooltipPos = e.inverted ? [hn(a.len + a.pos - e.plotLeft - y, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), r.len + r.pos - e.plotTop - M - S / 2, k] : [r.left - e.plotLeft + M + S / 2, hn(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), k],
        ...
        pointAttribs(t, e) {
            ...
            c = n.dashStyle || c,
            p = n.borderWidth || p)),
            e && t && (h = (a = hu(i.states[e], t.options.states?.[e] || {})).brightness,
            l = a.color || void 0 !== h && hr(l).brighten(a.brightness).get() || l,
            d = a[o] || d,
            p = a[r] || p,
            c = a.dashStyle || c,
            g = hf(a.opacity, g));
        ...
        drawTracker(t=this.points) {
            ...
            t.forEach(function(t) {
                e = hp(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [],
    ...
    let hy = hx
      ...
      , {format: hv} = eS
      , {defined: hk, extend: hw, fireEvent: hM, getAlignFactor: hS, isArray: hT, isString: hC, merge: hA, objectEach: hP, pick: hL, pInt: hO, splat: hE} = tn;
    !function(t) {
        function e() {
        ...
        function i(t, e, i, s, o) {
            let {chart: r, enabledDataSorting: a} = this
              ...
              , l = t.plotY
              , d = i.rotation || 0
              , c = hk(h) && hk(l) && r.isInsidePlot(h, Math.round(l), {
                inverted: n,
                paneCoordinates: !0,
                series: this
            })
              , p = 0 === d && "justify" === hL(i.overflow, a ? "none" : "justify")
              , g = this.visible && !1 !== t.visible && hk(h) && (t.series.forceDL || a && !p || c || hL(i.inside, !!this.options.stacking) && s && r.isInsidePlot(h, n ? s.x + 1 : s.y + s.height - 1, {
                inverted: n,
                paneCoordinates: !0,
                series: this
            }))
            ...
            i.hasDataLabels?.() && t.forEach(t => {
                ...
                hE(n(c, t.dlOptions || t.options?.dataLabels)).forEach( (n, l) => {
                    ...
                    let c = n.enabled && (t.visible || t.dataLabelOnHidden) && (!t.isNull || t.dataLabelOnNull) && function(t, e) {
                        ...
                        return !0
                    }(t, n), {backgroundColor: p, borderColor: g, distance: f, style: m={}} = n, x, y, b, v = {}, k = a[l], w = !k, M;
                    c && (y = hk(x = hL(n[t.formatPrefix + "Format"], n.format)) ? hv(x, t, s) : (n[t.formatPrefix + "Formatter"] || n.formatter).call(t, n),
                    b = n.rotation,
                    !s.styledMode && (m.color = hL(n.color, m.color, hC(i.color) ? i.color : void 0, "#000000"),
                    "contrast" === m.color ? ("none" !== p && (M = p),
                    t.contrastColor = r.getContrast("auto" !== M && hC(M) && M || (hC(h) ? h : "")),
                    m.color = M || !hk(f) && n.inside || 0 > hO(f || 0) || o.stacking ? t.contrastColor : d) : delete t.contrastColor,
                    ...
                    !k || c && hk(y) && !!(k.div || k.text?.foreignObject) == !!n.useHTML && (k.rotation && n.rotation || k.rotation === n.rotation) || (k = void 0,
                    w = !0),
                    c && hk(y) && "" !== y && (k ? v.text = y : (k = r.label(y, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " highcharts-tracker" : "")),
                    k && (k.options = n,
                    k.attr(v),
    ...
    (g = O || (O = {})).getCenter = function() {
        ...
        for (!e.angular || this instanceof ah || (g[3] = 0),
        c = 0; c < 4; ++c)
            p = g[c],
            h = c < 2 || 2 === c && /%$/.test(p),
    ...
    let hQ = O
      , {setAnimation: h0} = t5
      , {addEvent: h1, defined: h2, extend: h3, isNumber: h5, pick: h6, relativeLength: h9} = tn;
    class h4 extends rt {
        getConnectorPath(t) {
    ...
    class lr extends ah {
        ...
        translate(t) {
            li(this, "translate"),
            this.generatePoints();
            let e = this.options, i = e.slicedOffset, s = h8(e.startAngle, e.endAngle), o = this.startAngleRad = s.start, r = (this.endAngleRad = s.end) - o, a = this.points, n = e.ignoreHiddenPoint, h = a.length, l, d, c, p, g, u, f, m = 0;
    ...
    let {composed: la, noop: ln} = z
      , {distribute: lh} = eO
      , {series: ll} = rW
      , {arrayMax: ld, clamp: lc, defined: lp, isNumber: lg, pick: lu, pushUnique: lf, relativeLength: lm} = tn;
    !function(t) {
        let e = {
        ...
        function s() {
            ...
            e.forEach(t => {
                (t.dataLabels || []).forEach( (e, i) => {
                    let s = n[2] / 2
                      ...
                      , r = lm(o?.distance || 0, s);
                    0 === i && d[t.half].push(t),
                    !lp(o?.style?.width) && e.getBBox().width > a && (e.css({
                ...
                e.forEach(i => {
                    (i.dataLabels || []).forEach(l => {
                        let d = l.options || {}
                          ...
                          , S = "inherit";
                        if (x) {
                            if (g && lp(m) && x.distance > 0 && (void 0 === m.pos ? S = "hidden" : (f = m.size,
            ...
            (0 === ld(c) || this.verifyDataLabelOverflow(c)) && (this.placeDataLabels(),
        ...
        function r(t) {
            ...
            e[0] += (t[3] - t[1]) / 2),
            null !== s[1] ? r = lc(r, o, e[2] - Math.max(t[0], t[2])) : (r = lc(r, o, e[2] - t[0] - t[2]),
            e[1] += (t[0] - t[2]) / 2),
            r < e[2] ? (e[2] = r,
            e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, lm(i.innerSize || 0, r)), r),
            this.translate(e),
    ...
    let {pointInPolygon: ly} = I
      , {addEvent: lb, getAlignFactor: lv, fireEvent: lk, objectEach: lw, pick: lM} = tn;
    function lS(t, e) {
        let i, s = !1;
    ...
    let {defaultOptions: lT} = tD
      , {noop: lC} = z
      , {addEvent: lA, extend: lP, isObject: lL, merge: lO, relativeLength: lE} = tn
      , lI = {
        radius: 0,
        scope: "stack",
        where: void 0
    ...
    function lV(t, e) {
        ...
        o ? ((r = lX(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0,
    ...
    aE.compose(z.Chart),
    os.compose(z.Axis),
    (r = (f = z.Chart).prototype).hideOverlappingLabels || (r.hideOverlappingLabels = function(t) {
    ...
    lb(f, "render", function() {
        ...
        for (let i of t.yAxis || [])
            i.stacking && i.options.stackLabels && !i.options.stackLabels.allowOverlap && lw(i.stacking.stacks, t => {
                lw(t, t => {
